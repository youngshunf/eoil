    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a href="<?= Url::to(['site/index'])?>" class="logo">
          ...
          <span class="logo-mini"><b>油</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>e油网</b></span>
        </a>
            ...
            <li class="<?php if(yii::$app->controller->id=='goods') echo "active";?> treeview">
              <a href="#">
               ...
               <ul class="treeview-menu">
                ...
                <li class="<?php if(yii::$app->controller->id=='goods'&&yii::$app->controller->action->id=='goods') echo "active";?>" ><a href="<?= Url::to(['goods/goods'])?>"><i class="fa fa-circle-o"></i> 产品管理</a></li>
              </ul>
            </li>
            ...
            <li class="<?php if(yii::$app->controller->id=='news') echo "active";?> treeview">
              <a href="#">
               ...
               <!-- <li class="<?php if(yii::$app->controller->id=='news'&&yii::$app->controller->action->id=='index') echo "active";?>" ><a href="<?= Url::to(['news/index'])?>"><i class="fa fa-circle-o"></i> 分类管理</a></li> -->
                <li class="<?php if(yii::$app->controller->id=='news'&&yii::$app->controller->action->id=='rec') echo "active";?>" ><a href="<?= Url::to(['news/rec'])?>"><i class="fa fa-circle-o"></i> 行业推荐</a></li>
                <li class="<?php if(yii::$app->controller->id=='news'&&yii::$app->controller->action->id=='top') echo "active";?>" ><a href="<?= Url::to(['news/top'])?>"><i class="fa fa-circle-o"></i> 新闻头条</a></li>
              </ul>
            </li>
